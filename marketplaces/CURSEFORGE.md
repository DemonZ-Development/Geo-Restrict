...
One v2.0.0 jar supports Bukkit, Spigot, Paper, Purpur, Folia, BungeeCord, Waterfall and Velocity. GeoRestrict targets Java 17 bytecode, while the server itself may require a newer Java runtime.
